...
import cookedMeme from "@site/static/img/faqs/cookedMeme.png";
...
"[But BTC actually DID increase the blocksize!!](/faqs/BCH-vs-BTC/didnt-btc-already-increase-the-blocksize)" is a red herring [piece of propaganda](/faqs/BCH-vs-BTC/why-is-there-so-much-propaganda-in-btc#notable-propaganda).
...
- Creation & slow-to-build traction of new [community discussion hubs, podcasts, forums](/recommended#discussion--community) & in-person meetups.
...
<img src={cookedMeme} alt="Cooked meme" />

_No way to catch a marathon runner with a huge lead unless you can massively & sustainably outpace them. GSR = "Great Script Restoration", which is the less-elegant & less-refined BTC equivalent of the [VM Limits "Velma"](/faqs/Decentralisation/how-does-BCH-governance-work#2025-upgrade) BCH 2025 upgrade. [Original source](https://x.com/TheBCHPodcast/status/1883180174532866136)_
...
As of May 2025, this problem of social control with Bitcoin Core has already re-occured with the OP_RETURN "spam" issue, as predicted by this FAQ article. For more about that, see [Episode 151: Bitcoin Mechanic & The Architects of Spam](/episodes/151).
