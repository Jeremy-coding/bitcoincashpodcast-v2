...
This might seem like strange semantic pedantry, but it is actually critically important. This dispute stems from [history](/start#episode-8-of-10-bitcoin-cash), explains why [Bitcoin Cash will not rebrand](/faqs/BCH/will-bitcoin-cash-rebrand) and has very large stakes because the Bitcoin name and brand has a strong philosophical, linguistic and commercial value. It cuts to the legitimacy of each community/coin, and as Vitalik Buterin (co-founder of Ethereum) would say [the only scarce resource is legitimacy](https://vitalik.ca/general/2021/03/23/legitimacy.html). A community that can have its language controlled or redefined can have its thinking and actions controlled the same way - which is highly relevant in Bitcoin's environment of [censorship](/faqs/BCH-vs-BTC/why-is-there-so-much-censorship-in-btc) and [propaganda](/faqs/BCH-vs-BTC/why-is-there-so-much-propaganda-in-btc).

Each adopter of Bitcoin can decide for themselves what the "true vision" of Bitcoin is, and how much that matters to its implementation and their personal choices or usage as it's realised into the world. Some starting criteria and resources are suggested below.
...
How can a new user to the ecosystem decide whether Bitcoin Cash (BCH) or Bitcoin "Core" (BTC) is _the real_ Bitcoin? A number of recommended starting considerations is below, it is left to the user to determine the relative importance of each metric:
...
- **Visit adoption hotspots**: In heavy areas of Bitcoin Cash adoption, [such as the island nation St Kitts or the Bitcoin Cash City in Townsville, Australia](/faqs/BCH/is-BCH-spreading), "Bitcoin" already means BCH in common parlance because it is regularly transacted for goods and services. BTC is unused and irrelevant. Likewise, a similar phenomenon occurs in BTC hotspots such as Lugano, Switzerland or El Salvador. A visit to both kinds of those areas may prove enlightening. Another good way to directly compare the on-the-ground reality is visiting conferences for each community (such as [BLISS](https://bitcoincashpodcast.com/faqs/Events/BLISS) for BCH or [The BTC Conference](https://b.tc/conference) for BTC).
