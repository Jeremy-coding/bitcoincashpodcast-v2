...
A complete list of these misconceptions is nearly impossible, but a good start is the [BCH vs BTC section of the Podcast FAQs](/faqs#bitcoin-cash-bch-vs-bitcoin-core-btc). Note that this is the largest section of the FAQs, larger even than the [section about Bitcoin Cash itself](/faqs#bitcoin-cash-bch). This should give some indication of the scale of the problem.
...
For a look into the ongoing disillusionment as the BTC hoax collapses, see this segment of The BCH Podcast Episode 119 & 151:

<CustomReactPlayer url={"https://www.youtube.com/watch?v=aYcTqHrYKFc"} />

<CustomReactPlayer url={"https://www.youtube.com/watch?v=nFbh57enhh4"} />
:::

## Notable propaganda

There are of course [valid arguments](/faqs/BCH/why-not-bitcoin-cash) against BCH & the Podcast is [open to being proven wrong](/faqs/BCH-vs-BTC/how-could-btc-prove-you-wrong). However, the vast majority of attempts to debate, discuss or dismiss BCH are rife with egregious propaganda. Some of the most frequent recurring misconceptions or partially-valid-but-overapplied dismissals include:
...
- **"But BTC already raised the blocksize!"**: Sleight of hand & semantic conflation which [doesn't hold up to further context](/faqs/BCH-vs-BTC/didnt-btc-already-increase-the-blocksize), designed to pretend that the corruption of the [BTC hijacking](/faqs/Media/what-about-roger-vers-book-hijacking-bitcoin) is not as serious as it is.
- **Big blockers couldn't respect consensus**: Related to the propaganda about [soft/hard forks and chain splits](/faqs/Decentralisation/what-is-a-soft-hard-fork), many BTC advocates believe that SegWit was implemented with consensus despite the civil war that ensued over it. This is used to somehow dismiss BCH advocates on the false premise that they didn't understand Bitcoin or were unreasonably uncooperative, neither of which is true. See: [Was SegWit implemented with consensus](/faqs/BCH-vs-BTC/was-segwit-implemented-with-consensus).

## Alternative compilations

As of July 2025, even prominent figures within the BTC camp are beginning to notice the need to directly attack the enormous amount of misinformation & self-propagated deception they suffer from. Consider [this blost post from Paul Sztorc](https://www.truthcoin.info/blog/derangements/), listing what he calls "derangements". This is his attempt to provide an alternative to this FAQ article, although ironically he does it without a shred of self-introspection that [Jeremy tried to explain this problem to him two years earlier on Episode 89](https://bitcoincashpodcast.com/episodes/89). No matter how many times they are told, everyone must come to terms with [the Hijacking](/faqs/Media/what-about-roger-vers-book-hijacking-bitcoin) in their own time.
