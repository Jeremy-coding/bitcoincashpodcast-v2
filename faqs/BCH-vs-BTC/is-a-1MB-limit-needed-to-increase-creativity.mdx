...
When the problem itself is not trivial, there is absolutely no need to make it any more difficult than it already is - there's plenty of constraints imposed by available resources, competitors or physics to drive creativity in finding a solution.
