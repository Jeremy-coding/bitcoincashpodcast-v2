...
import johnCarvalhoUrl from "@site/static/img/faqs/johnCarvalho.png";
...
<img src={johnCarvalhoUrl} alt="John Carvalho" />

_Leftover BTC advocates, such as John Carvalho (who incorrectly supported BTC and derided BCH) are now trying to fight an [overwhelming tide of misinformation](/faqs/BCH-vs-BTC/why-is-there-so-much-propaganda-in-btc) about Bitcoin as unusable for payments & only "digital gold" [Source](https://x.com/BitcoinErrorLog/status/1821105327900627025)._
