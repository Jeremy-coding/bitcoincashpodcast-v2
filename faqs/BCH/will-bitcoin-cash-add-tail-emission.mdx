...
Refusing to add tail emission requires the BCH community to drive [global scale transaction volume](/faqs/Global-Reserve-Currency/what-do-you-mean-global-reserve-currency) before the inflation dries up too much. **If not, BCH will be insecure & die.** This is a very real possibility. The BCH community is both aware of & concerned about it.

However, the BCH community is not going to adopt tail emission - compromising the singular chance to deliver the world an inflation-free monetary standard - as an ego-salving cope for its failure on this important mission. If we fail, we fail. But the BCH community is [working hard every day](/faqs/Global-Reserve-Currency/how-will-BCH-onboard-the-entire-world) on it & [you can help out](/faqs/BCH/how-can-i-contribute-to-bitcoin-cash).
