...
As a new & often poorly-implemented technology, cryptocurrency advocates are often inadvertantly over-enthusiastic about the security provided by transaction confirmations. Misconceptions abound because of [the propaganda](/faqs/BCH-vs-BTC/why-is-there-so-much-propaganda-in-btc) of BTC advocates which includes [false claims Bitcoin is terrible payments technology](/faqs/Tech/Other/what-is-0-conf#btc-misconceptions). In addition, confirmations are both intriguing to curious new cryptocurrency adopters & broadly similar among all cryptocurrencies hence garner widespread familiarity. Many cryptocurrency adopters are conditioned to work around a system of confirmations in assessing their transactions' reliability.

The Bitcoin Cash community has a different strategy to many other communities in this regard. As far as possible, work is done to ensure [transactions are effectively instant](/faqs/Tech/Other/what-is-0-conf) & confirmations are irrelevant.

Transaction reliability is created as soon as a transaction is sent over the network through [first-seen node policy](/faqs/Tech/Other/what-is-0-conf), [Double Spend Proofs](/faqs/Tech/Other/what-is-0-conf#double-spend-proofs-dsps) & [Zero Confirmation escrows](/faqs/Tech/Other/what-is-0-conf#zero-confirmation-escrows-zces). Confirmations are intended as a formality rather than a requirement for most users in most cases (ultra-high value transactions may be a different case).
...
Cryptocurrency exchanges are a special case when it comes to transaction acceptance. See [this explanation](/faqs/Tech/Other/what-is-0-conf#cryptocurrency-exchanges).
