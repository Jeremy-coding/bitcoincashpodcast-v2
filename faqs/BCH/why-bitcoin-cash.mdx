...
<CustomReactPlayer url={"https://www.youtube.com/watch?v=ULkkGwSMVDM"} />

_Sayoshi Nakamario gives a detailed breakdown of Why Bitcoin Cash._

:::info

For a direct comparison with only BTC, see [What's wrong with Bitcoin BTC?
](/faqs/BCH-vs-BTC/whats-wrong-with-bitcoin-btc) and [Why does BCH already have what BTC wants?](/faqs/BCH-vs-BTC/why-does-btc-already-have-what-btc-wants)
...
Bitcoin Cash and [other Bitcoin forks](/faqs/Decentralisation/what-is-a-soft-hard-fork) have the following unique advantages vs all other coins:
...
Bitcoin Cash specifically has the following advantages vs all other coins, including [other Bitcoin forks](/faqs/Decentralisation/what-is-a-soft-hard-fork):
