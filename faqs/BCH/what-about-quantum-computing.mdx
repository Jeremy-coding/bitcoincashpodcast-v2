...
If anything, they've actually made the problem worse for themselves. Taproot formatted addresses (an ""upgrade"" which BCH does not have), are [extra-vulnerable to quantum computing](https://blog.bitjson.com/quantumroot/#can-an-upgrade-make-btcs-taproot-quantum-secure). Such is the result of an incompetent dev community.
...
[Post-Quantum Cryptography For Bitcoin | Dan Boneh on Bitcoin Rails](https://www.youtube.com/watch?v=F-HG87VJj_k).

<CustomReactPlayer url={"https://www.youtube.com/watch?v=F-HG87VJj_k"} />
...
<CustomReactPlayer url={"https://www.youtube.com/watch?v=NTj3otRXz0w"} />

[Brandon Black on What Bitcoin Did - "The Quantum Computing Myth"](https://www.youtube.com/watch?v=uZZkQRqnNE4)

<CustomReactPlayer url={"https://www.youtube.com/watch?v=uZZkQRqnNE4"} />
