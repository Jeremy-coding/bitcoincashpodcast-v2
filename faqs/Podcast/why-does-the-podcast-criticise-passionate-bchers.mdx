...
import achillesUrl from "@site/static/img/faqs/achilles.png";

<img src={dramaticExitUrl} alt="Dramatic exit" />

_If you try to please everyone, you end up pleasing no one._
...
<img src={achillesUrl} alt="Achilles tweet" />
