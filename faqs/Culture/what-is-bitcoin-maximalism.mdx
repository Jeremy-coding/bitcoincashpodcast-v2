...
While being open to technological innovations, BCH maximalists must also stay alert for and repel fiat banking or other subversive interests. [Bitcoin might be for everyone, but that doesn't mean tolerating them all](/faqs/BCH-vs-BTC/isnt-bitcoin-for-everyone).
