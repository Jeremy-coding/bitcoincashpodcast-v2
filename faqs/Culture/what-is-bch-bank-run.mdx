...
Some exchanges publish proof of reserves, which is worth keeping an eye on to investigate the impact of bank runs.

- [Binance](https://www.binance.com/en/proof-of-reserves): Suspiciously, among all major coins, **Binance DOES NOT REPORT BCH balances**. Repeated requests for clarity have been ignored.
- [BitMex](https://www.bitmex.com/app/porl): As of 5th September 2025, has a suspiciously low balance of only 748 BCH.
