...
As of May 2025, Jason Dreyzehner had [released a production ready quantum resistant vault for BCH](https://blog.bitjson.com/quantumroot/?x=1), with increases in efficiency active after the May 2026 Layla upgrade. Integration into wallet tooling is expected also by May 2026, with rollout to wallets to follow. The BCH community can then begin migrating active and cold storage coins to quantum safety ahead of any quantum computer attacks.
...
If anything, they've actually made the problem worse for themselves. Taproot addreses (an ""upgrade"" which BCH does not have), are [extra-vulnerable to quantum computing](https://blog.bitjson.com/quantumroot/#can-an-upgrade-make-btcs-taproot-quantum-secure). Such is the result of an incompetent dev community.
