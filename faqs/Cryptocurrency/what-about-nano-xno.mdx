...
- **Instant transactions**: Just as with fees, there is no end-user perceivable difference between Nano and many other "instant" cryptocurrencies, including Bitcoin Cash. Bitcoin Cash has [secure 0-confirmation transactions to $10 000+](/faqs/Tech/Other/what-is-0-conf) which are just as fast as Nano, and any larger transactions are not only rare but generally not conducted with haste so great that it can't afford waiting 10 minutes for a block confirmation (when buying a house, it takes some time to sign the papers).
