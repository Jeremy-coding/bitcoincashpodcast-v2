...
<CustomReactPlayer url={"https://www.youtube.com/watch?v=bxznd49Fi3c"} />

<CustomReactPlayer url={"https://www.youtube.com/watch?v=y3OnuKf9U3Y"} />

_The BCH community has developed the CHIP process for deciding on upgrades without a centralised decision making process. This has been very effective in producing high-quality and bug-free upgrades among a group of heavily invested and [sometimes contrarian parties](/faqs/Podcast/why-does-the-podcast-criticise-passionate-bchers) for the last several years._

:::tip

Dive into upcoming upgrade proposals & sentiment at [Consensus.cash](https://www.consensus.cash)!

:::

Bitcoin Cash is decentralised, meaning it is a system with no one in charge or able to force action from anyone else. If this is unintuitive, consider it like the Internet itself - no one is "in charge" of the Internet, no one "owns" the Internet & no web page is the "center" of the Internet. There is no "official Internet office building", no "Internet CEO" and no "Internet customer support line". The Internet is an open system maintained by a wide variety of loosely coordinated amateur & professional individuals & groups in an organic (and sometimes messy) way. BCH is the exact same.
...
- No "central" website
- No verified Twitter account (although [BitcoinCashOG](https://x.com/BitcoinCashOG) runs one to represent the community of their own initiative.)
...
Most critically, BCH currently has three active, independent full node protocol developer teams:

- [Bitcoin Cash Node](https://bitcoincashnode.org/en/) aka BCHN
- [BCHD](https://bchd.cash/)
- [Knuth](https://github.com/k-nuth/kth)

And three more inactive or non-consensus projects:
...
See this video by Satoshi's Angels (later reuploaded by the BCH Foundation, both other community run organisations) for more information:

<CustomReactPlayer url={"https://www.youtube.com/watch?v=GfedpYKnLFY"} />
...
As of June 2026, the 2027 upgrade is being discussed in the community. The current most likely proposal is for 1 Minute Blocks, as described in detail [here](https://gitlab.com/0353F40E/fablous).

## 2026 Upgrade

The 2026 upgrade went live on mainnet May 15th 2026, with celebrations [at BLISS 2026](https://www.bliss.cash)!

For information on the upgrade itself, see this video:

<CustomReactPlayer url={"https://www.youtube.com/watch?v=adF_Y7y5eiI"} />

## 2025 Upgrade

The 2025 upgrade took place on May 15th 2025, with celebrations [at BLISS 2025](https://www.bliss.cash/2025)!

For information on the upgrade itself, see this video:

<CustomReactPlayer url={"https://www.youtube.com/watch?v=uOIzAcCap6A"} />

## 2024 Upgrade

The 2024 network upgrade was May 15th 2024. For info on the upgrade, see [ABLA](/faqs/BCH/what-is-the-maximum-bch-blocksize) & for the full livestream & surrounding details, see [BLISS](/faqs/Events/BLISS).

<CustomReactPlayer url={"https://www.youtube.com/watch?v=YkkzIjZQNH0"} />

## 2023 Upgrade livestream

The 2023 upgrade was May 15th 2023. Check out the community live stream of the upgrade activating!

<CustomReactPlayer url={"https://www.youtube.com/watch?v=_Nu05NghoYM"} />

## 2022 Upgrade livestream

The 2022 network upgrade was May 15th 2022.

<CustomReactPlayer url={"https://www.youtube.com/watch?v=RzavspmhNlQ"} />
